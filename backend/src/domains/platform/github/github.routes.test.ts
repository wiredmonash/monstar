...
/**
 * Characterization tests for the LIVE v2 github endpoint
 ...
 */
describe('GET /api/v2/github/contributors', () => {
  it('returns formatted, sorted, human contributors (200)', async () => {
    ...
    const res = await request(global.app).get('/api/v2/github/contributors');

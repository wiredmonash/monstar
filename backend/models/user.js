    ...
    try {
        ...
        if (user.profileImg) {
            try {
                ...
                if (result.result !== 'ok') {
                    console.error(`[User] Error deleting profile image from Cloudinary: ${result.result}`);
                } else {
                    console.log('[User] Successfully deleted profile image from Cloudinary ');
                }
            } catch (cloudinaryError) {
                console.error(`[User] Error deleting profile image from Cloudinary: ${cloudinaryError}`);
            }
        }
    }
    catch (error) {
